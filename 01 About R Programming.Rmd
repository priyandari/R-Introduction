...
[Pemrograman R]() bukanlah sebuah judul film sebagaimana [RRRrrrr!!!](https://www.youtube.com/watch?v=4Kg8UJ_MqoM) yang bergenre komedi sejarah dan dirilis tahun 2004, atau film [R](https://en.wikipedia.org/wiki/R_(film)) yang dirilis tahun 2010 yang berkisah tentang peredaran obat terlarang di suatu penjara :).

![RRRrrrr!!!](images\RRRrrrr.jpg) ![R](images\R_2010.jpg) 

&nbsp;
\newline
\newline

## __R__ sebaga Bahasa Pemrograman 
...
2. Pemrograman R memang dahulu terbilang cukup sulit digunakan, namun karena semakin banyaknya libary siap pakai yang telah dikembangkan oleh sejumlah pihak, maka membuat suatu pengolahan data statistik dan grafik bukanlah hal menyulitkan lagi.  
