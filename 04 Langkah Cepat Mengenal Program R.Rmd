...
```{r}
# myData <- read.csv("F:/71 TUTORIALS/R-introduction/data/irisData.csv")
# Atau menggunakan

directori <-getwd()
directori <-paste0(directori,"/data/irisData.csv")
myData <- read.csv(directori, header = TRUE)
myData
...
```{r}
write.csv(myData, "F:/71 TUTORIALS/R-introduction/data/irisDataEkspor.csv")
```
